...
public class Utils {
	...
	public static JSONObject getTestProject() {
		JSONObject jsonObject = (JSONObject) JSONSerializer.toJSON("{"
				...
				+ "    \"self\": \"http://www.example.com/jira/rest/api/2/project/EX\"," + "    \"id\": \"10000\","
				+ "    \"key\": \"EX\"," + "    \"description\": \"This project was created as an example for REST.\","
				+ "    \"lead\": {" + "        \"self\": \"http://www.example.com/jira/rest/api/2/user?username=fred\","
				+ "        \"name\": \"fred\"," + "        \"avatarUrls\": {"
				+ "            \"48x48\": \"http://www.example.com/jira/secure/useravatar?size=large&ownerId=fred\","
				+ "            \"24x24\": \"http://www.example.com/jira/secure/useravatar?size=small&ownerId=fred\","
				+ "            \"16x16\": \"http://www.example.com/jira/secure/useravatar?size=xsmall&ownerId=fred\","
				+ "            \"32x32\": \"http://www.example.com/jira/secure/useravatar?size=medium&ownerId=fred\""
				+ "        }," + "        \"displayName\": \"Fred F. User\"," + "        \"active\": false" + "    },"
				+ "    \"components\": [" + "        {"
				+ "            \"self\": \"http://www.example.com/jira/rest/api/2/component/10000\","
				+ "            \"id\": \"10000\"," + "            \"name\": \"Component 1\","
				+ "            \"description\": \"This is a JIRA component\"," + "            \"lead\": {"
				...
				+ "                \"active\": false" + "            },"
				+ "            \"assigneeType\": \"PROJECT_LEAD\"," + "            \"assignee\": {"
				+ "                \"self\": \"http://www.example.com/jira/rest/api/2/user?username=fred\","
				+ "                \"name\": \"fred\"," + "                \"avatarUrls\": {"
				+ "                    \"48x48\": \"http://www.example.com/jira/secure/useravatar?size=large&ownerId=fred\","
				+ "                    \"24x24\": \"http://www.example.com/jira/secure/useravatar?size=small&ownerId=fred\","
				...
				+ "                }," + "                \"displayName\": \"Fred F. User\","
				+ "                \"active\": false" + "            },"
				+ "            \"realAssigneeType\": \"PROJECT_LEAD\"," + "            \"realAssignee\": {"
				+ "                \"self\": \"http://www.example.com/jira/rest/api/2/user?username=fred\","
				+ "                \"name\": \"fred\"," + "                \"avatarUrls\": {"
				+ "                    \"48x48\": \"http://www.example.com/jira/secure/useravatar?size=large&ownerId=fred\","
				+ "                    \"24x24\": \"http://www.example.com/jira/secure/useravatar?size=small&ownerId=fred\","
				...
				+ "                    \"32x32\": \"http://www.example.com/jira/secure/useravatar?size=medium&ownerId=fred\""
				+ "                }," + "                \"displayName\": \"Fred F. User\","
				+ "                \"active\": false" + "            }," + "            \"isAssigneeTypeValid\": false,"
				+ "            \"project\": \"HSP\"," + "            \"projectId\": 10000" + "        }" + "    ],"
				+ "    \"issueTypes\": [" + "        {"
				+ "            \"self\": \"http://localhost:8090/jira/rest/api/2.0/issueType/3\","
				+ "            \"id\": \"3\"," + "            \"description\": \"A task that needs to be done.\","
				...
				+ "            \"id\": \"1\"," + "            \"description\": \"A problem with the software.\","
				...
				+ "    \"email\": \"from-jira@example.com\"," + "    \"assigneeType\": \"PROJECT_LEAD\","
				+ "    \"versions\": []," + "    \"name\": \"Example\"," + "    \"roles\": {"
	...
	public static JSONObject getProjectRole() {
		JSONObject jsonObject = (JSONObject) JSONSerializer.toJSON(
				"{\nself: \"https://beyondbytes.atlassian.net/rest/api/latest/project/10000/role/10000\","
				+ "\nname: \"Users\",\nid: 10000,\ndescription: \"A project role that represents users in a project\","
				+ "\nactors: [\n{\nid: 10124,\ndisplayName: \"Project Manager [X]\",\ntype: \"atlassian-user-role-actor\","
				+ "\nname: \"projectmanager\",\navatarUrl: "
				+ "\"https://beyondbytes.atlassian.net/secure/useravatar?size=xsmall&avatarId=10122\"\n},\n{\nid: 10803,"
				+ "\ndisplayName: \"Sajin Sebastian\",\ntype: \"atlassian-user-role-actor\",\nname: \"sajin@beyondbytes.co.in\","
				+ "\navatarUrl: \"https://beyondbytes.atlassian.net/secure/useravatar?size=xsmall&avatarId=10122\"\n},\n{\nid: 10125,"
				+ "\ndisplayName: \"Shweta Moody\",\ntype: \"atlassian-user-role-actor\",\nname: \"shweta moody\","
				+ "\navatarUrl: \"https://beyondbytes.atlassian.net/secure/useravatar?size=xsmall&ownerId=sunanda%40beyondbytes.co.in&avatarId=11101\"\n},"
				+ "\n{\nid: 10117,\ndisplayName: \"Thanneermalai Lakshmanan\",\ntype: \"atlassian-user-role-actor\",\nname: \"tm@beyondbytes.co.in\","
				+ "\navatarUrl: \"https://beyondbytes.atlassian.net/secure/useravatar?size=xsmall&ownerId=bbytes&avatarId=10602\"\n}\n]\n}");
		return jsonObject;
	}
